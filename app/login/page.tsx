...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // モバイルデバイスの場合はモバイル専用検索ページへ、それ以外は通常の検索ページへ
      const redirectPath = isMobileDevice() ? "/mobile/search" : "/search";
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="w-full max-w-[506px]">
          ...
          <div className="bg-white rounded-[10px] shadow-[0px_2px_8px_rgba(0,0,0,0.08)] p-10 border border-[#D9D9D9] w-full">
            <h2 className="text-[24px] font-bold text-[#333333] mb-[30px]">
              ログイン
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                />
                {errors.email && (
                  <p className="text-[14px] text-[#FF4D4F] mt-2">
                    ※{errors.email}
                  </p>
                )}
              </div>
