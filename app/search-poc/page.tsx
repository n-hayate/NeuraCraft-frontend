...
ルール：
 - 本文にない断定はしない。不明は「不明」と書く。
 - 失敗症状がない場合、失敗症状のみ記載し、以降は記載しない。
 - 出力の文字数は1500文字程度を上限とする。但し参照するデータが少ないなどの場合は1000文字より少なくてもよい。
 - 回答にあたり、余計な前置きはなるべく省略する
...
ルール：
    - 全体の文字数は1500文字程度を上限とする。但し参照するデータが少ないなどの場合は1000文字より少なくてもよい。
    - 回答にあたり、余計な前置きはなるべく省略する。
出力（各レポートごと）：
